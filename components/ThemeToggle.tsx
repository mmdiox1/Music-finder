...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ darkMode, toggle }) => {
  return (
    <button
      onClick={toggle}
      className="p-3 bg-gray-100 dark:bg-gray-800 rounded-2xl text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors shadow-sm"
